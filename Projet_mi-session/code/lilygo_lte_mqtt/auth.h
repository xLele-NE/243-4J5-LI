...
const char MQTT_BROKER[] = "mqtt.xlele.ca";
const int  MQTT_PORT = 1883;  // Port standard MQTT (non-SSL via LTE)
const char MQTT_USER[] = "esp_user";
const char MQTT_PASS[] = "Teladmin1$";  // ⚠️ À remplacer par votre mot de passe MQTT
...
const char MQTT_CLIENT_ID[] = "lte-xlele";     // ⚠️ À personnaliser selon votre appareil
