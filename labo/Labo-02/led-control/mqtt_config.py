...
MQTT_CONFIG = {
    ...
    "username": "esp_user",
    "password": "Teladmin1$",  # ⚠️ Remplacez par votre mot de passe réel

    # Device ID de votre ESP32
    # Format: esp32-xlele (les 6 derniers caractères de l'adresse MAC)
    "device_id": "lte-xlele",  # ⚠️ OBLIGATOIRE: Remplacez par l'ID réel affiché par l'ESP32
}
